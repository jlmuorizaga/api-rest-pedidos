...
const getEspecialidadesBySucursal = (request, response) => {
    ...
    pool.query(
        'SELECT DISTINCT ep.id as "idEspecialidad",ep.nombre,ep.ingredientes,ep.ruta_imagen '
...
const getProductosBySucursal = (request, response) => {
    const cve_sucursal = request.params.cve_sucursal
    pool.query(
        'SELECT pro.id, descripcion, tamanio,rs.precio_normal as "precioNormal", pro.ruta_imagen '
...
const getTipoProductosBySucursal = (request, response) => {
    const cve_sucursal = request.params.cve_sucursal
    pool.query(
        'SELECT distinct pt.id,pt.descripcion,pt.imgUrl as imgUrl '
